...
- Product category: Local commerce subscription
- Product homepage: https://www.doordash.com/dashpass/
- Product summary: DashPass is DoorDash's membership program offering benefits such as reduced delivery and service fees on eligible orders.
- Why it matters: DashPass increases order frequency and consumer lock-in while giving DoorDash another lever over merchant eligibility, consumer discovery, and fee economics.
...
- LNbits (open-source): LNbits is a free and open-source Lightning wallet and accounts system with an extension model and API that can support payment, account, and membership experiments.. Homepage: https://docs.lnbits.com/. Repo: https://github.com/lnbits/lnbits.
...
- LNbits Documentation (LNbits) - https://docs.lnbits.com/
  Why it matters: Documentation for open-source Lightning wallet, accounts, API, and extension infrastructure.
- lnbits/lnbits (GitHub) - https://github.com/lnbits/lnbits
  Why it matters: Open-source repository for LNbits, used to validate the alternative's software availability.
