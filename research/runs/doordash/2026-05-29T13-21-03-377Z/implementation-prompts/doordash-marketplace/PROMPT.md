...
- Product category: Local commerce marketplace
- Product homepage: https://www.doordash.com/
- Product summary: DoorDash Marketplace lets consumers order from restaurants, grocers, retailers, and other local merchants for delivery or pickup through DoorDash's app and website.
- Why it matters: The marketplace is DoorDash's core demand aggregator and logistics coordination layer, concentrating consumer traffic, merchant discovery, pricing, delivery dispatch, and support inside one platform.
...
- A credible replacement would not start as a universal DoorDash clone. It would begin with a city, neighborhood, university, cooperative grocery network, restaurant association, or courier collective that already has local trust and repeat demand.
- Open-source storefronts, cooperative delivery software, transparent fee schedules, and interoperable reputation could reduce platform rent while preserving enough convenience for repeat use.

## Existing Alternatives Worth Studying First

- CoopCycle (cooperative): CoopCycle is a federation and software platform for worker-owned bike delivery cooperatives, offering logistics and ecommerce tools for local delivery groups.. Homepage: https://coopcycle.org/en/. Repo: https://github.com/coopcycle.
- Open Food Network (open-source): Open Food Network is an open-source marketplace platform for farmers, food producers, distributors, and community food hubs.. Homepage: https://openfoodnetwork.org/. Repo: https://github.com/openfoodfoundation/openfoodnetwork.
...
- DoorDash Marketplace Product Addendum (DoorDash Help Center) - https://help.doordash.com/en-au/merchants/article/merchant-terms-of-service-us-english-marketplace-product-addendum
  Why it matters: Defines DoorDash Marketplace and describes order flow, merchant promotion, delivery availability, and commission deductions.
...
- Open Food Network (Open Food Network) - https://openfoodnetwork.org/
  Why it matters: Primary project page for the open-source local food marketplace platform and reported enterprise footprint.
- openfoodfoundation/openfoodnetwork (GitHub) - https://github.com/openfoodfoundation/openfoodnetwork
  Why it matters: Public repository for the Open Food Network marketplace software.
