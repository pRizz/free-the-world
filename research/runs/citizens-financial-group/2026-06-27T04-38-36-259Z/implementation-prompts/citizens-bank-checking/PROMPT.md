...
- GNU Taler (GNUnet e.V. and Taler Systems SA) - https://taler.net/
  Why it matters: Free-software payment system used as an enabler for privacy-preserving open payment rails.
