...
- Tandoor Recipes (Tandoor Recipes) - https://tandoor.dev/
  Why it matters: Open-source recipe-management project used as an enabler for repeatable household, group, and cooperative recipe workflows.
- Tandoor Recipes GitHub Repository (GitHub / TandoorRecipes) - https://github.com/TandoorRecipes/recipes
  Why it matters: Public source repository for Tandoor Recipes, including project activity and licensing context.
