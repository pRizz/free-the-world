...
- OpenEnergyMonitor GitHub Organization (OpenEnergyMonitor) - https://github.com/openenergymonitor
  Why it matters: Public source repository organization for validating openness and active project maintenance of the monitoring stack.
- Performance Evaluation of an Advanced Distributed Energy Resource Management Algorithm (National Renewable Energy Laboratory) - https://research-hub.nrel.gov/en/publications/performance-evaluation-of-an-advanced-distributed-energy-resource-4/
  Why it matters: Research source for distributed energy resource management and hardware-in-the-loop testing of DER dispatch algorithms.
