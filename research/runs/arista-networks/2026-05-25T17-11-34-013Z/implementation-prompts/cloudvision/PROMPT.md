...
- Product category: Network automation and observability
- Product homepage: https://www.arista.com/en/products/eos/eos-cloudvision
- Product summary: CloudVision is Arista's platform for cloud network automation, visibility, telemetry, and operational workflows.
- Why it matters: CloudVision increases customer dependence on Arista by centralizing network state, compliance, telemetry, and automation around Arista-managed infrastructure.
...
- A replacement would combine vendor-neutral models, streaming telemetry, open collectors, source-controlled configuration, and automation workflows.
- The main challenge is not collecting data; it is matching CloudVision's integrated inventory, compliance, remediation, and support experience across heterogeneous production networks.

## Existing Alternatives Worth Studying First

- OpenConfig and gNMI (protocol): OpenConfig provides vendor-neutral data models and gNMI-based management interfaces for network configuration and telemetry.. Homepage: https://www.openconfig.net/. Repo: https://github.com/openconfig.
...
- OpenConfig (OpenConfig Project) - https://www.openconfig.net/
  Why it matters: Open-source vendor-neutral network management project used for decentralized management and telemetry analysis.
- OpenConfig gRPC Network Management Interface (OpenConfig Project) - https://openconfig.net/docs/gnmi/gnmi-specification/
  Why it matters: Technical specification for gNMI, supporting the CloudVision replacement analysis.
