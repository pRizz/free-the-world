---
productSlug: wisconsin-public-service
companySlug: wec-energy-group
generatedOn: 2026-06-03
---

# Build A Free Alternative To WEC Energy Group's Wisconsin Public Service
...
- Product: Wisconsin Public Service
- Product slug: wisconsin-public-service
- Product category: Regulated electric and natural gas utility service
- Product homepage: https://www.wisconsinpublicservice.com/company/about
- Product summary: Wisconsin Public Service provides electric and natural gas service in northeast and central Wisconsin as a WEC Energy Group subsidiary.
- Why it matters: WPS extends WEC's regulated utility footprint beyond the We Energies brand and is another example of durable local energy delivery infrastructure facing only partial edge pressure from distributed energy systems.
...
- A credible replacement path would focus on locally managed energy use, behind-the-meter generation, open monitoring, and demand flexibility rather than pretending that a software project can replace poles, wires, substations, or gas delivery.
- Customer-owned and community-owned systems could reduce bills, peak loads, and outage exposure while still interacting with WPS for interconnection and backup service.

## Existing Alternatives Worth Studying First

- OpenEnergyMonitor Emoncms (open-source): Emoncms is an open-source web application for processing, logging, and visualizing energy, temperature, and environmental data, and is part of the OpenEnergyMonitor project.. Homepage: https://github.com/emoncms/emoncms. Repo: https://github.com/emoncms/emoncms.
- OpenEMS (open-source): OpenEMS is an open-source energy management system for coordinating distributed energy resources such as storage, renewable generation, EV charging, and flexible loads.. Homepage: https://openems.io/. Repo: https://github.com/OpenEMS/openems.
...
- Emoncms GitHub Repository (OpenEnergyMonitor) - https://github.com/emoncms/emoncms
  Why it matters: Primary repository source for the open-source Emoncms energy data processing, logging, and visualization application.
...
- Wisconsin Public Service About Us (Wisconsin Public Service) - https://www.wisconsinpublicservice.com/company/about
  Why it matters: Customer-facing source for Wisconsin Public Service's electric and natural gas service territory and WEC Energy Group subsidiary status.
...
1. Restate the target: build a free, open, decentralized, cooperative, or protocol-first alternative that creates real pressure on WEC Energy Group's Wisconsin Public Service business.
