...
- Product summary: Welltower's senior housing portfolio includes operating and triple-net senior living communities positioned around aging-demographic demand.
- Why it matters: Senior housing is Welltower's central growth engine and one of the clearest examples of capital-intensive care infrastructure that could be partially challenged by cooperative ownership, open operations software, and distributed services.
...
- A realistic replacement would not be a single open-source building owner. It would be a stack of resident cooperatives, community land or mission-aligned ownership structures, open facility-management software, and interoperable care tools that lower operating overhead and reduce dependence on large REIT capital.
- The highest-leverage opening is at the operating and ownership-coordination layer: local groups can share procurement, maintenance workflows, care coordination, and financing templates while keeping control closer to residents and communities.

## Existing Alternatives Worth Studying First

- Senior housing cooperatives (cooperative): Senior housing cooperatives use resident ownership and governance to provide an alternative to investor-owned senior living real estate.. Homepage: https://www.seniorcoops.org/.
- openMAINT (open-source): openMAINT is an open-source property and facility-management system for buildings, infrastructure, assets, maintenance, logistics, and related economic activities.. Homepage: https://www.openmaint.org/en/product/project.
...
- Senior Cooperative Housing Resources (Cooperative Housing Resources) - https://www.seniorcoops.org/LTCs.pdf
  Why it matters: Background source for senior housing cooperative models and resident-centered alternatives to investor-owned senior living real estate.
