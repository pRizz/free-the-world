---
productSlug: bny-mellon-investment-management
companySlug: bank-of-new-york-mellon
generatedOn: 2026-05-27
---

# Build A Free Alternative To Bank of New York Mellon's BNY Mellon Investment Management
...
- Product: BNY Mellon Investment Management
- Product slug: bny-mellon-investment-management
- Product category: asset-management
- Product homepage: https://www.bny.com/investments
- Product summary: BNY Mellon Investment Management is BNY's global asset-management platform, offering investment strategies through specialist managers and multi-asset capabilities.
- Why it matters: Investment management converts trust, distribution, research, portfolio construction, compliance, and risk systems into fee income, making it a natural target for open-source portfolio analytics and more transparent investment coordination models.
...
- Open-source portfolio construction and performance tooling can give advisers, institutions, and sophisticated individuals more control over model design, backtesting, allocation, and reporting.
- The harder replacement problem is governance: institutions still need accountable fiduciaries, risk committees, audited processes, and operational support. Open tools are strongest when they make the investment process more inspectable rather than pretending to replace the entire manager relationship at once.

## Existing Alternatives Worth Studying First

- skfolio (open-source): skfolio is an open-source Python library for portfolio optimization, risk management, stress testing, and systematic allocation workflows.. Homepage: https://skfoliolabs.com/. Repo: https://github.com/skfolio/skfolio.
- Portfolio Performance (open-source): Portfolio Performance is an open-source desktop application for tracking and evaluating investment portfolios across stocks, cryptoassets, and other holdings.. Homepage: https://www.portfolio-performance.info/. Repo: https://github.com/portfolio-performance/portfolio.
...
- Portfolio Performance GitHub Repository (Portfolio Performance) - https://github.com/portfolio-performance/portfolio
  Why it matters: Open-source portfolio tracking and performance-evaluation application relevant to local-first portfolio reporting and auditable investment workflows.
- skfolio - Open Source Portfolio Optimization and Risk Management (skfolio Labs) - https://skfoliolabs.com/
  Why it matters: Open-source portfolio optimization and risk-management tooling relevant to investment-management disruption concepts.
...
1. Restate the target: build a free, open, decentralized, cooperative, or protocol-first alternative that creates real pressure on Bank of New York Mellon's BNY Mellon Investment Management business.
