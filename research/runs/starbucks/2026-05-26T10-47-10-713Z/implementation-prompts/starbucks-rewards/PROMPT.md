...
- Product category: Loyalty program and digital ordering
- Product homepage: https://www.starbucks.com/rewards/
- Product summary: Starbucks Rewards combines customer identity, offers, points, stored-value reloads, app ordering, and redemption into a closed loyalty layer around Starbucks purchases.
- Why it matters: Rewards is not just a coupon program; it is a demand-routing system that gives Starbucks direct customer data, repeat-visit incentives, and a way to steer payment behavior through its own app.
...
- A credible replacement would let independent cafes share a common customer identity, earn-and-redeem rules, fraud controls, and local discovery while keeping ownership of their own customer relationships.
- The strongest path is not a single Starbucks clone, but a federated loyalty and ordering stack that local operators can run jointly while customers experience one portable wallet or rewards identity.

## Existing Alternatives Worth Studying First

- Open Loyalty (open-source): Open Loyalty provides open loyalty-system components and related public repositories that can be adapted for points, rewards, and customer engagement programs.. Homepage: https://openloyalty.io/. Repo: https://github.com/OpenLoyalty.
...
- Open Loyalty GitHub Organization (Open Loyalty) - https://github.com/OpenLoyalty
  Why it matters: Public repositories for open loyalty components relevant to replacing closed rewards infrastructure.
