...
- The more plausible decentralization path is unbundling: open payment APIs, open-source lending cores, local credit unions, merchant cooperatives, and provider-owned financing pools could replace parts of the private-label card stack without replacing every bank function at once.
...
- GNU Taler (open-source): A free-software payment system for privacy-friendly online and point-of-sale transactions, with wallet, merchant, exchange, and integration documentation.. Homepage: https://www.taler.net/en/.
...
- GNU Taler (GNUnet e.V. and Taler Systems SA) - https://www.taler.net/en/
  Why it matters: Free-software payment-system source used as an open checkout and merchant-payment alternative/enabler.
