...
- OpenADR Alliance Homepage (OpenADR Alliance) - https://www.openadr.org/
  Why it matters: Describes OpenADR as an open two-way information exchange model for demand response and distributed energy resources.
- OpenEnergyMonitor Homepage (OpenEnergyMonitor) - https://openenergymonitor.org/
  Why it matters: Documents open-source monitoring for electricity, solar, storage, and heat pumps.
