...
- Community Solar Basics (U.S. Department of Energy) - https://www.energy.gov/cmei/systems/community-solar-basics
  Why it matters: Defines community solar, bill-credit mechanics, subscriber models, consumer protections, and national availability context.
- NRG Energy 2025 Form 10-K Annual Report (NRG Energy / SEC EDGAR via CompaniesMarketCap) - https://companiesmarketcap.com/nrg-energy/sec-reports-10k/0001013871-26-000004/
  Why it matters: Supports customer count, brand portfolio, operating segments, 2025 revenue, and 2025 net income.
- NRG Energy Market Capitalization (CompaniesMarketCap) - https://companiesmarketcap.com/nrg-energy/marketcap/
  Why it matters: Provides June 2026 market capitalization, share price, and market-cap history.
- NRG Energy P/E Ratio (CompaniesMarketCap) - https://companiesmarketcap.com/nrg-energy/pe-ratio/
  Why it matters: Provides June 2026 trailing P/E ratio used for valuation input metrics.
- OpenEMS GitHub Repository (OpenEMS Association / GitHub) - https://github.com/OpenEMS/openems
  Why it matters: Provides repository, licensing, architecture, supported devices, and active project signals for OpenEMS.
- OpenEMS Project Homepage (OpenEMS Association) - https://openems.io/
  Why it matters: Describes OpenEMS as a free and open-source energy management system for distributed energy resources.
