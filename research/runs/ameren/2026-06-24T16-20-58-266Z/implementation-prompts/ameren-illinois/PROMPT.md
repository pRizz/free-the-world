...
- Product category: Regulated electric and natural gas delivery service
- Product homepage: https://www.ameren.com/illinois
- Product summary: Ameren Illinois is a regulated electric and natural gas delivery company serving about 1.2 million electric customers and more than 800,000 natural gas customers in central and southern Illinois.
- Why it matters: Ameren Illinois' delivery-only electric model makes the wires monopoly visible: customers may choose supply, but delivery, reliability, grid planning, and gas infrastructure remain controlled by the incumbent utility.
...
- A credible alternative would not be a second set of poles, wires, and gas mains. It would be a customer-side stack of distributed generation, batteries, flexible loads, open demand response, and heat-pump electrification that reduces dependence on utility-delivered energy volume.
- Ameren Illinois would likely remain the delivery utility in the near term, but open DER coordination and neighborhood-scale electrification could shift more operational intelligence and investment choice to customers, communities, and aggregators.

## Existing Alternatives Worth Studying First

- OpenEMS (open-source): OpenEMS is an open-source energy management system for coordinating local energy assets such as storage, renewables, EV charging, heat pumps, tariffs, and flexible loads.. Homepage: https://openems.io/. Repo: https://github.com/OpenEMS/openems.
- OpenADR (protocol): OpenADR is an open standard for automated demand response and distributed energy resource management across utilities, aggregators, and energy management systems.. Homepage: https://www.openadr.org/.
...
- Heat Pump Systems (U.S. Department of Energy) - https://www.energy.gov/energysaver/heat-pump-systems
  Why it matters: Technical source for heat pumps as an efficient electrification pathway that can reduce fossil heating demand.
