...
- Product category: Domestic ground parcel delivery
- Product homepage: https://www.fedex.com/en-us/shipping/ground.html
- Product summary: FedEx Ground provides day-definite ground parcel delivery for residential and commercial shipments in the United States and Canada.
- Why it matters: Ground delivery is where route density, local station coverage, pickup frequency, contractor and driver operations, and last-mile reliability convert scale into cost advantage.
...
- The strongest replacement path is local-first: cooperative courier fleets, open routing, shared pickup points, neighborhood lockers, and merchant-owned delivery rules that reduce dependence on a single parcel carrier.
- The replacement does not need to match every FedEx lane to matter; it can start by taking dense urban routes, same-day local commerce, returns, and specialty delivery categories.

## Existing Alternatives Worth Studying First

- OpenTripPlanner (open-source): OpenTripPlanner is an open-source multimodal trip-planning project that combines open-standard data such as OpenStreetMap and GTFS for transportation network analysis.. Homepage: https://www.opentripplanner.org/. Repo: https://github.com/opentripplanner/OpenTripPlanner.
- GraphHopper (open-source): GraphHopper is an open-source routing engine for OpenStreetMap that can be self-hosted for route calculation, map matching, and vehicle-specific routing.. Homepage: https://www.graphhopper.com/open-source/. Repo: https://github.com/graphhopper/graphhopper.
...
- FedEx Ground Shipping Services (FedEx Corporation) - https://www.fedex.com/en-us/shipping/ground.html
  Why it matters: Product page for FedEx Ground day-definite domestic ground delivery services.
...
- OpenTripPlanner (OpenTripPlanner) - https://www.opentripplanner.org/
  Why it matters: Official project page for open-source multimodal trip planning and transportation network analysis.
- OpenTripPlanner GitHub Repository (OpenTripPlanner) - https://github.com/opentripplanner/OpenTripPlanner
  Why it matters: Source repository for OpenTripPlanner, used to support openness and readiness scoring.
