...
- Product category: Health benefits and insurance services
- Product homepage: https://www.cigna.com/
- Product summary: Cigna Healthcare provides medical, dental, behavioral health, and related benefit products and services for employers, individuals, and government-linked markets.
- Why it matters: It is the public-facing insurance and benefits layer where members, employers, providers, and brokers interact with Cigna's network, pricing, claims, and care-management systems.
...
- A realistic replacement path would start with narrower benefit pools, self-funded employer groups, direct primary care networks, open records, transparent claims administration, and member-owned data access instead of trying to recreate a national insurer in one jump.
- Open-source clinical records and FHIR-based claims portability can make care coordination less dependent on a single benefits administrator, while cooperative purchasing groups could handle some employer-benefit functions with clearer governance.

## Existing Alternatives Worth Studying First

- OpenMRS (open-source): OpenMRS is an open-source electronic medical record platform maintained by a global community.. Homepage: https://openmrs.org/. Repo: https://github.com/openmrs.
- GNU Health (open-source): GNU Health is a free/libre health and hospital information system for health practitioners, institutions, and governments.. Homepage: https://health.gnu.org/.
...
- GNU Health (GNU Solidario) - https://health.gnu.org/
  Why it matters: Free/libre health and hospital information system relevant to open healthcare infrastructure alternatives.
- OpenMRS (OpenMRS) - https://openmrs.org/
  Why it matters: Open-source electronic medical record platform relevant to patient-data and care-coordination alternatives.
- OpenMRS GitHub Organization (OpenMRS) - https://github.com/openmrs
  Why it matters: Public code organization for OpenMRS projects.
- OpenMRS Product (OpenMRS) - https://openmrs.org/product/
  Why it matters: Product documentation and release context for the OpenMRS electronic medical record platform.
