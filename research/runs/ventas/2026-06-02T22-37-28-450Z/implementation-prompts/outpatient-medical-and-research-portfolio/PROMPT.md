...
- Product category: Outpatient medical and research real estate
- Product homepage: https://www.ventasreit.com/what-we-do/outpatient-medical-and-research
- Product summary: Ventas' outpatient medical and research portfolio includes medical office, ambulatory, and research-oriented properties tied to health systems, universities, and life-science users.
- Why it matters: These properties sit at the intersection of patient access, research infrastructure, long-term leasing, and specialized building systems, making them difficult to replace with ordinary office space.
...
- A realistic replacement path would target the building-operations layer first: open building management, open data models, and interoperable facilities software can reduce proprietary lock-in in medical and research buildings.
- A more ambitious path would pair nonprofit or cooperative ownership with open facilities standards so health systems and research tenants can reduce dependence on large external landlords.

## Existing Alternatives Worth Studying First

- OpenRemote Building Management (open-source): OpenRemote is an open-source IoT and building-management platform that can connect building systems, sensors, and automation workflows.. Homepage: https://openremote.io/building-managemement-system-bms-open-source/. Repo: https://github.com/openremote/openremote.
- Project Haystack (open-source): Project Haystack is an open-source initiative for standardizing semantic tags and data models for building automation, control, energy, HVAC, lighting, and environmental systems.. Homepage: https://www.project-haystack.org/.
...
- Building Management System Open Source (OpenRemote) - https://openremote.io/building-managemement-system-bms-open-source/
  Why it matters: Open-source building-management platform used as an alternative and enabler for open facilities operations.
- Project Haystack (Project Haystack) - https://www.project-haystack.org/
  Why it matters: Open-source building data and tagging initiative for automation, HVAC, energy, and environmental systems.
