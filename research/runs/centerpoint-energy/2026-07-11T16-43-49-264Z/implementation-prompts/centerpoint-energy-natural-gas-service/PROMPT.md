---
productSlug: centerpoint-energy-natural-gas-service
...
- Company description: CenterPoint Energy is a regulated U.S. multi-utility providing electric transmission and distribution, limited Indiana generation, and natural gas distribution services.
- Product: Natural gas service
- Product slug: centerpoint-energy-natural-gas-service
...
- OpenEMS (open-source): OpenEMS can coordinate heat pumps with renewable generation, storage, tariffs and other controllable loads as part of an open building electrification stack.. Homepage: https://openems.io/. Repo: https://github.com/OpenEMS/openems.
- OpenEnergyMonitor and Emoncms (open-source): OpenEnergyMonitor provides open-source monitoring for electricity, solar, storage and heat pumps, with Emoncms as an open-source platform for processing, logging and visualizing energy data.. Homepage: https://openenergymonitor.org/. Repo: https://github.com/emoncms/emoncms.
