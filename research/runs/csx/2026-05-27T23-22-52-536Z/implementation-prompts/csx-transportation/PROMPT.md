...
- Product category: Freight railroad transportation
- Product homepage: https://www.csx.com/index.cfm/about-us/company-overview/network-and-operations/
- Product summary: CSX Transportation is the railroad operating business behind CSX's eastern North American freight network, moving merchandise, bulk commodities, coal, automotive freight, and intermodal traffic.
- Why it matters: The business represents a hard-to-replicate transportation layer for U.S. industrial supply chains, making it a useful test case for where decentralization can realistically pressure infrastructure incumbents and where physical network control remains decisive.
...
- A realistic open replacement would not start by building a new eastern railroad. It would begin with open infrastructure data, neutral telematics, transparent service commitments, and cooperative short-line or terminal coordination that gives shippers better routing and accountability across existing assets.
- Over time, federated rail visibility and shipper-owned coordination tools could reduce dependence on any one carrier's proprietary portals, while local operators and short lines compete for specific first-mile and last-mile flows.

## Existing Alternatives Worth Studying First

- OpenRailwayMap (open-source): OpenRailwayMap is an OpenStreetMap-based open-source railway infrastructure map that exposes track, speed, electrification, gauge, and related railway attributes where contributors have mapped them.. Homepage: https://www.openrailwaymap.org/. Repo: https://github.com/OpenRailwayMap/OpenRailwayMap.
- RailPulse (hybrid): RailPulse is a neutral, open-architecture railcar telematics platform formed by railcar owners to improve real-time visibility, safety, and collaboration across North American freight rail assets.. Homepage: https://railpulse.com/about/.
