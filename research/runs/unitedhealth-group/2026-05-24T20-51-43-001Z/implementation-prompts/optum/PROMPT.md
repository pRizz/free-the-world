...
- Product: Optum
- Product slug: optum
- Product category: Health services, pharmacy care, care delivery, and health data infrastructure
- Product homepage: https://www.optum.com/
- Product summary: Optum is UnitedHealth Group's health services platform, spanning care delivery, pharmacy benefit management, analytics, consulting, and technology-enabled health operations.
- Why it matters: Optum gives UnitedHealth influence beyond insurance by embedding the company in provider operations, pharmacy economics, data infrastructure, and care-management workflows.
...
- A practical replacement stack would combine open electronic health records, interoperable patient data APIs, transparent analytics, and provider-controlled workflow software rather than one vertically integrated services platform.
- Open-source clinical systems can reduce software lock-in, but pharmacy benefit management, specialty pharmacy, and scaled care delivery remain institutionally and contractually complex.

## Existing Alternatives Worth Studying First

- OpenMRS (open-source): OpenMRS is an open-source electronic medical record platform built by a global community for clinics, facilities, and health systems.. Homepage: https://openmrs.org/. Repo: https://github.com/openmrs.
...
- Health Level 7 (HL7) Fast Healthcare Interoperability Resources (FHIR) (Office of the National Coordinator for Health Information Technology) - https://healthit.gov/interoperability/investments/fhir/
  Why it matters: Explains FHIR as a widely used API-focused standard for representing and exchanging health information.
- OpenEMR GitHub Repository (GitHub) - https://github.com/openemr/openemr
  Why it matters: Public repository describing OpenEMR as a free and open-source EHR and medical practice management application.
- OpenMRS Product (OpenMRS) - https://openmrs.org/product/
  Why it matters: Product page for OpenMRS clinical records capabilities across facilities and networks.
...
- What We Do (OpenMRS) - https://openmrs.org/what-we-do/
  Why it matters: Describes OpenMRS as an open-source EMR platform and global community.
