...
- Product summary: Dominion provides regulated natural gas distribution service, including pipeline distribution, customer connections, metering, safety operations, and billing in gas service areas.
- Why it matters: Gas service shapes home heating, water heating, industrial heat, and utility infrastructure investment; it is also a major target for substitution by electrification, efficiency, and local thermal systems.
...
- The most credible replacement path is not decentralized gas production for ordinary households. It is demand reduction and substitution: heat pumps, building electrification, thermal storage, weatherization, and district or campus energy systems that reduce dependence on delivered fossil gas.
- Open controls can matter at the edge by coordinating electric loads and thermal storage so customers can leave gas appliances without simply shifting all peak burden back to the utility.
...
- Heat Pump Systems (U.S. Department of Energy) - https://www.energy.gov/energysaver/heat-pump-systems
  Why it matters: Source for heat-pump electrification as a practical substitute for some gas heating loads.
