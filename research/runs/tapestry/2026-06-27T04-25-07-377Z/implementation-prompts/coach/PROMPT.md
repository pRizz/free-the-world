...
- Company description: Tapestry owns Coach and Kate Spade New York, global fashion and accessories brands focused on handbags, leather goods, apparel, footwear, accessories, and lifestyle products.
- Product: Coach
- Product slug: coach
...
- Business Profile
  Tapestry is a New York-based fashion group whose current consumer brand portfolio is Coach and Kate Spade New York; its website describes the company as a global house of iconic brands and lists Coach as founded in 1941 and Kate Spade New York as founded in 1993.
...
- The harder pieces to decentralize are status, taste-making, quality assurance, returns, warranty handling, and supply-chain trust. Open pattern commons and maker cooperatives can pressure generic products and repair demand, but they do not fully replace a global fashion brand.
...
- Tapestry (TPR) Market Capitalization (CompaniesMarketCap) - https://companiesmarketcap.com/tapestry/marketcap/
  Why it matters: Market-data source for June 2026 market capitalization and approximate global rank.
- Tapestry (TPR) P/E Ratio (CompaniesMarketCap) - https://companiesmarketcap.com/tapestry/pe-ratio/
  Why it matters: Market-data source for Tapestry's June 2026 trailing P/E ratio.
- Tapestry 2025 Form 10-K (Tapestry / SEC) - https://companiesmarketcap.com/tapestry/sec-reports-10k/0001116132-25-000019/
  Why it matters: Primary source for fiscal 2025 sales, segment mix, operating income, impairment context, and net income.
- Tapestry Our Brands (Tapestry) - https://www.tapestry.com/our-brands/
  Why it matters: Current official brand overview for Coach and Kate Spade New York, including founding dates, net sales, and store counts.
