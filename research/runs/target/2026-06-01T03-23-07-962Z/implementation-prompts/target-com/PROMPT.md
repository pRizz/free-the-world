...
- Product summary: Target.com is Target's digital storefront for search, product discovery, ecommerce checkout, loyalty, pickup, shipping, and same-day fulfillment.
- Why it matters: Target.com extends the store moat into digital discovery and data-driven personalization while using nearby stores as fulfillment infrastructure.
...
- Solidus (open-source): Open-source ecommerce framework based on Ruby on Rails for building customizable online stores.. Homepage: https://solidus.io/. Repo: https://github.com/solidusio/solidus.
- Open Food Network (open-source): Open-source marketplace platform focused on local food commerce and community distribution networks.. Homepage: https://openfoodnetwork.org/. Repo: https://github.com/openfoodfoundation/openfoodnetwork.
...
- Solidus Introduction (Solidus) - https://guides.solidus.io/4.2/
  Why it matters: Technical documentation describing Solidus as a free open-source ecommerce platform.
- solidusio/solidus (Solidus) - https://github.com/solidusio/solidus
  Why it matters: Public repository for the Solidus open-source ecommerce framework.
