...
- Apache Fineract for Business Banking (open-source): Apache Fineract is an open-source core banking platform that can provide account, savings, lending, transaction, ledger, and reporting infrastructure for financial institutions and cooperative finance providers.. Homepage: https://fineract.apache.org/. Repo: https://github.com/apache/fineract.
...
- Apache Fineract (Apache Software Foundation) - https://fineract.apache.org/
  Why it matters: Open-source core banking platform used as a plausible banking-ledger and financial-services infrastructure alternative.
...
- Open Bank Project (TESOBE) - https://www.openbankproject.com/
  Why it matters: Open-source open-banking API platform relevant to account access, payments, bank-as-a-platform integrations, and portability concepts.
