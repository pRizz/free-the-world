...
- Product summary: Diamond Green Diesel is Valero's renewable diesel joint venture, producing renewable diesel and sustainable aviation fuel from renewable feedstocks.
- Why it matters: Renewable diesel and SAF are among the more practical liquid-fuel transition products for existing diesel and aviation infrastructure, but their availability and economics depend on feedstocks, policy credits, lifecycle accounting, and large process facilities.
...
- A lighter replacement path is not a single open refinery but a network of smaller regional feedstock loops that collect waste oils, fats, and biomass and route them to the most appropriate local use.
- Open process simulation and small-scale processing tools can help communities understand what is technically and economically realistic before overbuilding local fuel capacity.

## Existing Alternatives Worth Studying First

- DWSIM (open-source): DWSIM is a free, open-source chemical process simulator that includes use cases such as bioethanol and biodiesel production modeling.. Homepage: https://dwsim.org/.
- BioSTEAM (open-source): BioSTEAM is an open-source platform for biorefinery simulation, techno-economic analysis, and life-cycle assessment.. Homepage: https://github.com/BioSTEAMDevelopmentGroup/biosteam. Repo: https://github.com/BioSTEAMDevelopmentGroup/biosteam.
...
- BioSTEAM (BioSTEAM Development Group) - https://github.com/BioSTEAMDevelopmentGroup/biosteam
  Why it matters: Open-source biorefinery simulation, techno-economic analysis, and life-cycle assessment project.
- DWSIM: Open-Source Chemical Process Simulator (DWSIM) - https://dwsim.org/
  Why it matters: Open-source process simulation tool relevant to biodiesel, bioethanol, and fuel-process modeling.
