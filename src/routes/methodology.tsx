      ...
      <div class="space-y-8">
          ...
          <div class="grid gap-4 lg:grid-cols-2">
            {Object.values(companyMetricDefinitions).map((metric) => (
              <MetricCard
                ...
                class="[&>p:first-child]:text-accent-foreground"
              >
        ...
        <ContentCard class="space-y-5">
          ...
          <p class="text-sm leading-7 text-muted-foreground">
            These are the repo's declared biases. They prevent the writing from quietly smuggling in
            a static-world worldview while pretending to evaluate decentralization objectively.
          </p>
          <div class="space-y-4">
