...
export const CardTitle = createCardPrimitive("h2", "text-2xl font-semibold tracking-tight text-title-foreground");
export const CardDescription = createCardPrimitive("p", "max-w-3xl text-sm leading-7 text-muted-foreground sm:text-base");
