...
export function TextFieldInput(props: any) {
  const [local, rest] = splitProps(props, ["class"]);
...
export function TextFieldDescription(props: KTextField.TextFieldDescriptionProps & { class?: string }) {
  const [local, rest] = splitProps(props, ["class"]);
  return <KTextField.Description class={cn("text-sm text-muted-foreground", local.class)} {...rest} />;
}

export function TextFieldErrorMessage(props: KTextField.TextFieldErrorMessageProps & { class?: string }) {
  const [local, rest] = splitProps(props, ["class"]);
