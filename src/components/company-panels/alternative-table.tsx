          ...
          <For each={props.alternatives}>
            {(alternative) => (
              <TableRow>
                ...
                <TableCell>
                  {formatAlternativeMetric("openness", alternative.metrics.openness)}
                </TableCell>
                <TableCell>
                  {formatAlternativeMetric(
                    "decentralizationFit",
                    alternative.metrics.decentralizationFit,
                  )}
                </TableCell>
                <TableCell>
                  {formatAlternativeMetric("readiness", alternative.metrics.readiness)}
                </TableCell>
                <TableCell>
                  {formatAlternativeMetric("costLeverage", alternative.metrics.costLeverage)}
                </TableCell>
                <TableCell>
                  <div class="flex flex-col gap-2">
                    {alternative.homepageUrl ? (
                      <a
                        href={alternative.homepageUrl}
                        target="_blank"
                        rel="noreferrer"
