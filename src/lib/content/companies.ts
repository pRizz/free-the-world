...
type BaseCompanyMetricId = "moat" | "decentralizability" | "profitability" | "peRatio" | "marketCap";
...
function buildCompany(
  ...
  const metrics: Company["metrics"] = {
    ...
    freedCapitalPotential: assessment(
      ...
      uniqueSourceIds(company.baseMetrics.marketCap.sourceIds, company.baseMetrics.decentralizability.sourceIds),
      "speculative"
    ),
  };
...
export const companies: Company[] = [
  buildCompany({
    ...
    sourceIds: ["nvidia-investor", "nvidia-data-center", "nvidia-cuda", "nvidia-marketcap", "nvidia-ipo-prospectus", "amd-rocm"],
    ...
    baseMetrics: {
      ...
      marketCap: assessment(4_300_000_000_000, "Approximate market cap snapshot from public market trackers.", ["nvidia-marketcap"], "medium"),
    },
  }),
  buildCompany({
    slug: "apple",
    ...
    sourceIds: ["apple-investor", "apple-iphone", "apple-services", "apple-marketcap", "apple-ipo-prospectus", "grapheneos", "nextcloud", "syncthing"],
    ...
    baseMetrics: {
      ...
      marketCap: assessment(3_700_000_000_000, "Approximate market cap snapshot from public market trackers.", ["apple-marketcap"], "medium"),
    },
  }),
  buildCompany({
    slug: "microsoft",
    ...
    sourceIds: ["microsoft-investor", "microsoft-365", "azure", "microsoft-marketcap", "microsoft-ipo-prospectus", "libreoffice", "gitea", "nextcloud"],
    ...
    baseMetrics: {
      ...
      marketCap: assessment(3_300_000_000_000, "Approximate market cap snapshot from public market trackers.", ["microsoft-marketcap"], "medium"),
    },
  }),
  buildCompany({
    slug: "alphabet",
    ...
    sourceIds: ["alphabet-investor", "google-products", "google-cloud", "alphabet-marketcap", "alphabet-ipo-prospectus", "searxng", "peertube"],
    technologyWaveIds: ["bitcoin-native-coordination"],
    baseMetrics: {
      ...
      marketCap: assessment(2_400_000_000_000, "Approximate market cap snapshot from public market trackers.", ["alphabet-marketcap"], "medium"),
    },
  }),
  buildCompany({
    slug: "amazon",
    ...
    sourceIds: ["amazon-investor", "amazon-store", "aws", "amazon-marketcap", "amazon-ipo-prospectus", "openstack", "minio", "akash"],
    ...
    baseMetrics: {
      ...
      marketCap: assessment(2_200_000_000_000, "Approximate market cap snapshot from public market trackers.", ["amazon-marketcap"], "medium"),
    },
  }),
  buildCompany({
    slug: "meta-platforms",
    ...
    sourceIds: ["meta-investor", "meta-tech", "whatsapp", "meta-marketcap", "meta-ipo-prospectus", "meta-ipo-registration", "mastodon", "pixelfed", "matrix"],
    technologyWaveIds: ["bitcoin-native-coordination"],
    baseMetrics: {
      ...
      marketCap: assessment(1_800_000_000_000, "Approximate market cap snapshot from public market trackers.", ["meta-marketcap"], "medium"),
    },
  }),
  buildCompany({
    slug: "broadcom",
    ...
    sourceIds: ["broadcom-investor", "vmware", "broadcom-home", "broadcom-marketcap", "broadcom-ipo-prospectus", "proxmox", "openstack"],
    technologyWaveIds: ["printed-electronics"],
    baseMetrics: {
      ...
      marketCap: assessment(1_100_000_000_000, "Approximate market cap snapshot from public market trackers.", ["broadcom-marketcap"], "medium"),
    },
  }),
  buildCompany({
    slug: "tesla",
    ...
    sourceIds: ["tesla-investor", "tesla-modely", "tesla-energy", "tesla-marketcap", "tesla-ipo-prospectus", "openpilot", "openevse", "openems"],
    ...
    baseMetrics: {
      ...
      marketCap: assessment(1_000_000_000_000, "Approximate market cap snapshot from public market trackers.", ["tesla-marketcap"], "medium"),
    },
  }),
  buildCompany({
    ...
    baseMetrics: {
      ...
      marketCap: assessment(900_000_000_000, "Approximate market cap snapshot from public market trackers.", ["berkshire-marketcap"], "medium"),
    },
  }),
  buildCompany({
    slug: "walmart",
    ...
    sourceIds: ["walmart-investor", "walmart-store", "walmart-about", "walmart-marketcap", "walmart-stock-split-history", "walmart-ipo-digest", "open-food-network"],
    ...
    baseMetrics: {
      ...
      marketCap: assessment(800_000_000_000, "Approximate market cap snapshot from public market trackers.", ["walmart-marketcap"], "medium"),
    },
  }),
];
