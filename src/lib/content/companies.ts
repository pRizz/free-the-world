...
function buildCompany(
  company: Omit<Company, "metrics" | "snapshotNote"> & {
    baseMetrics: Record<Exclude<CompanyMetricId, "freedCapitalPotential">, MetricAssessment>;
  }
): Company {
  ...
  return {
    ...
    metrics: {
      ...
      freedCapitalPotential: assessment(
        ...
        [...company.baseMetrics.marketCap.sourceIds, ...company.baseMetrics.decentralizability.sourceIds],
        "speculative"
      ),
    },
  };
