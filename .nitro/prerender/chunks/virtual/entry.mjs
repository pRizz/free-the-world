import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineHandler, H3, redirect, getRequestIP, parseCookies, getCookie, setCookie, fromWebHandler } from 'file:///workspace/node_modules/h3/dist/_entries/node.mjs';
import { getRequestEvent, renderToString, renderToStream, createComponent, ssr, ssrHydrationKey, ssrAttribute, escape, ssrElement, mergeProps as mergeProps$1, Dynamic, isServer, spread, useAssets as useAssets$1, delegateEvents, NoHydration, Hydration, HydrationScript } from 'file:///workspace/node_modules/solid-js/web/dist/server.js';
import { sharedConfig, Suspense, mergeProps, splitProps, createMemo, createUniqueId, useContext, lazy as lazy$1, createContext, createSignal, onCleanup, createRenderEffect, children, getOwner, on, runWithOwner, untrack, Show, createRoot, startTransition, resetErrorBoundaries, batch, createComponent as createComponent$1, catchError, ErrorBoundary as ErrorBoundary$1 } from 'file:///workspace/node_modules/solid-js/dist/server.js';
import { join } from 'file:///workspace/node_modules/pathe/dist/index.mjs';
import { createRouter as createRouter$1 } from 'file:///workspace/node_modules/radix3/dist/index.mjs';
import { fromJSON, crossSerializeStream, getCrossReferenceHeader } from 'file:///workspace/node_modules/seroval/dist/esm/production/index.mjs';
import { CustomEventPlugin, DOMExceptionPlugin, EventPlugin, FormDataPlugin, HeadersPlugin, ReadableStreamPlugin, RequestPlugin, ResponsePlugin, URLSearchParamsPlugin, URLPlugin } from 'file:///workspace/node_modules/seroval-plugins/dist/esm/production/web.mjs';
import { clsx } from 'file:///workspace/node_modules/clsx/dist/clsx.mjs';
import { twMerge } from 'file:///workspace/node_modules/tailwind-merge/dist/bundle-mjs.mjs';
import { cva } from 'file:///workspace/node_modules/class-variance-authority/dist/index.mjs';
import { provideRequestEvent } from 'file:///workspace/node_modules/solid-js/web/storage/dist/storage.js';
import { parseSetCookie } from 'file:///workspace/node_modules/cookie-es/dist/index.mjs';

const clientViteManifest = { "_company-panels-D_xc-4GQ.js": { "file": "_build/assets/company-panels-D_xc-4GQ.js", "name": "company-panels", "imports": ["_ui-DjNvePuT.js", "_metrics-BLwUwxMk.js", "_formatters-D2eBEgAr.js", "_selectors-CTaceZq1.js", "_components-CMuzSOXA.js"] }, "_components-CMuzSOXA.js": { "file": "_build/assets/components-CMuzSOXA.js", "name": "components", "imports": ["_ui-DjNvePuT.js"] }, "_config-C089QPBC.js": { "file": "_build/assets/config-C089QPBC.js", "name": "config" }, "_formatters-D2eBEgAr.js": { "file": "_build/assets/formatters-D2eBEgAr.js", "name": "formatters", "imports": ["_metrics-BLwUwxMk.js"] }, "_index-CQlEsshY.js": { "file": "_build/assets/index-CQlEsshY.js", "name": "index", "imports": ["_ui-DjNvePuT.js"] }, "_metrics-BLwUwxMk.js": { "file": "_build/assets/metrics-BLwUwxMk.js", "name": "metrics" }, "_selectors-CTaceZq1.js": { "file": "_build/assets/selectors-CTaceZq1.js", "name": "selectors", "imports": ["_formatters-D2eBEgAr.js", "_technology-waves-B7Kp3KMR.js"] }, "_site-u07gApsB.js": { "file": "_build/assets/site-u07gApsB.js", "name": "site" }, "_source-list-Dj1_M_X8.js": { "file": "_build/assets/source-list-Dj1_M_X8.js", "name": "source-list", "imports": ["_ui-DjNvePuT.js"] }, "_technology-waves-B7Kp3KMR.js": { "file": "_build/assets/technology-waves-B7Kp3KMR.js", "name": "technology-waves" }, "_ui-DjNvePuT.js": { "file": "_build/assets/ui-DjNvePuT.js", "name": "ui" }, "src/entry-client.tsx": { "file": "_build/assets/entry-client-Cat7AY7o.js", "name": "entry-client", "src": "src/entry-client.tsx", "isEntry": true, "imports": ["_ui-DjNvePuT.js", "_index-CQlEsshY.js", "_config-C089QPBC.js", "_components-CMuzSOXA.js"], "dynamicImports": ["src/routes/[...404].tsx?pick=default&pick=$css", "src/routes/[...404].tsx?pick=default&pick=$css", "src/routes/about.tsx?pick=default&pick=$css", "src/routes/about.tsx?pick=default&pick=$css", "src/routes/index.tsx?pick=default&pick=$css", "src/routes/index.tsx?pick=default&pick=$css", "src/routes/methodology.tsx?pick=default&pick=$css", "src/routes/methodology.tsx?pick=default&pick=$css", "src/routes/companies/[companySlug].tsx?pick=default&pick=$css", "src/routes/companies/[companySlug].tsx?pick=default&pick=$css", "src/routes/companies/index.tsx?pick=default&pick=$css", "src/routes/companies/index.tsx?pick=default&pick=$css", "src/routes/companies/[companySlug]/products.tsx?pick=default&pick=$css", "src/routes/companies/[companySlug]/products.tsx?pick=default&pick=$css", "src/routes/companies/[companySlug]/products/[productSlug].tsx?pick=default&pick=$css", "src/routes/companies/[companySlug]/products/[productSlug].tsx?pick=default&pick=$css"], "css": ["_build/assets/entry-client-DFcViSQv.css"] }, "src/routes/[...404].tsx?pick=default&pick=$css": { "file": "_build/assets/_...404_-hKhvHXQc.js", "name": "_...404_", "src": "src/routes/[...404].tsx?pick=default&pick=$css", "isEntry": true, "isDynamicEntry": true, "imports": ["_ui-DjNvePuT.js", "_components-CMuzSOXA.js"] }, "src/routes/about.tsx?pick=default&pick=$css": { "file": "_build/assets/about-D0zIRmZH.js", "name": "about", "src": "src/routes/about.tsx?pick=default&pick=$css", "isEntry": true, "isDynamicEntry": true, "imports": ["_ui-DjNvePuT.js", "_index-CQlEsshY.js", "_site-u07gApsB.js"] }, "src/routes/companies/[companySlug].tsx?pick=default&pick=$css": { "file": "_build/assets/_companySlug_-DU6VD0EC.js", "name": "_companySlug_", "src": "src/routes/companies/[companySlug].tsx?pick=default&pick=$css", "isEntry": true, "isDynamicEntry": true, "imports": ["_ui-DjNvePuT.js", "_index-CQlEsshY.js", "_company-panels-D_xc-4GQ.js", "_source-list-Dj1_M_X8.js", "_selectors-CTaceZq1.js", "_components-CMuzSOXA.js", "_metrics-BLwUwxMk.js", "_formatters-D2eBEgAr.js", "_technology-waves-B7Kp3KMR.js"] }, "src/routes/companies/[companySlug]/products.tsx?pick=default&pick=$css": { "file": "_build/assets/products-B64FggnQ.js", "name": "products", "src": "src/routes/companies/[companySlug]/products.tsx?pick=default&pick=$css", "isEntry": true, "isDynamicEntry": true, "imports": ["_ui-DjNvePuT.js", "_index-CQlEsshY.js", "_company-panels-D_xc-4GQ.js", "_source-list-Dj1_M_X8.js", "_selectors-CTaceZq1.js", "_components-CMuzSOXA.js", "_metrics-BLwUwxMk.js", "_formatters-D2eBEgAr.js", "_technology-waves-B7Kp3KMR.js"] }, "src/routes/companies/[companySlug]/products/[productSlug].tsx?pick=default&pick=$css": { "file": "_build/assets/_productSlug_-BKThtDe8.js", "name": "_productSlug_", "src": "src/routes/companies/[companySlug]/products/[productSlug].tsx?pick=default&pick=$css", "isEntry": true, "isDynamicEntry": true, "imports": ["_ui-DjNvePuT.js", "_index-CQlEsshY.js", "_company-panels-D_xc-4GQ.js", "_selectors-CTaceZq1.js", "_components-CMuzSOXA.js", "_metrics-BLwUwxMk.js", "_formatters-D2eBEgAr.js", "_technology-waves-B7Kp3KMR.js"] }, "src/routes/companies/index.tsx?pick=default&pick=$css": { "file": "_build/assets/index-fUFlkcx-.js", "name": "index", "src": "src/routes/companies/index.tsx?pick=default&pick=$css", "isEntry": true, "isDynamicEntry": true, "imports": ["_ui-DjNvePuT.js", "_index-CQlEsshY.js", "_metrics-BLwUwxMk.js", "_formatters-D2eBEgAr.js", "_selectors-CTaceZq1.js", "_components-CMuzSOXA.js", "_technology-waves-B7Kp3KMR.js"] }, "src/routes/index.tsx?pick=default&pick=$css": { "file": "_build/assets/index-BQOG95AY.js", "name": "index", "src": "src/routes/index.tsx?pick=default&pick=$css", "isEntry": true, "isDynamicEntry": true, "imports": ["_ui-DjNvePuT.js", "_index-CQlEsshY.js", "_config-C089QPBC.js", "_formatters-D2eBEgAr.js", "_site-u07gApsB.js", "_components-CMuzSOXA.js", "_metrics-BLwUwxMk.js"] }, "src/routes/methodology.tsx?pick=default&pick=$css": { "file": "_build/assets/methodology-DWpXi-oT.js", "name": "methodology", "src": "src/routes/methodology.tsx?pick=default&pick=$css", "isEntry": true, "isDynamicEntry": true, "imports": ["_ui-DjNvePuT.js", "_index-CQlEsshY.js", "_metrics-BLwUwxMk.js", "_site-u07gApsB.js", "_technology-waves-B7Kp3KMR.js"] } };
...
const fileRoutes = [{ "page": true, "$component": { "src": "src/routes/[...404].tsx?pick=default&pick=$css", "build": () => import(
  /* @vite-ignore */
  '../_/_...404_-CmhySjzA.mjs'
), "import": () => import(
  /* @vite-ignore */
  '../_/_...404_-CmhySjzA.mjs'
) }, "path": "/*404" }, { "page": true, "$component": { "src": "src/routes/about.tsx?pick=default&pick=$css", "build": () => import(
  /* @vite-ignore */
  '../_/about-BsZsniKD.mjs'
), "import": () => import(
  /* @vite-ignore */
  '../_/about-BsZsniKD.mjs'
) }, "path": "/about" }, { "page": true, "$component": { "src": "src/routes/index.tsx?pick=default&pick=$css", "build": () => import(
  /* @vite-ignore */
  '../_/index-D1yvbRj1.mjs'
), "import": () => import(
  /* @vite-ignore */
  '../_/index-D1yvbRj1.mjs'
) }, "path": "/" }, { "page": true, "$component": { "src": "src/routes/methodology.tsx?pick=default&pick=$css", "build": () => import(
  /* @vite-ignore */
  '../_/methodology-EwgM50ll.mjs'
), "import": () => import(
  /* @vite-ignore */
  '../_/methodology-EwgM50ll.mjs'
) }, "path": "/methodology" }, { "page": true, "$component": { "src": "src/routes/companies/[companySlug].tsx?pick=default&pick=$css", "build": () => import(
  /* @vite-ignore */
  '../_/_companySlug_-C_3cvCXR.mjs'
), "import": () => import(
  /* @vite-ignore */
  '../_/_companySlug_-C_3cvCXR.mjs'
) }, "path": "/companies/:companySlug" }, { "page": true, "$component": { "src": "src/routes/companies/index.tsx?pick=default&pick=$css", "build": () => import(
  /* @vite-ignore */
  '../_/index-CHZQGW6B.mjs'
), "import": () => import(
  /* @vite-ignore */
  '../_/index-CHZQGW6B.mjs'
) }, "path": "/companies/" }, { "page": true, "$component": { "src": "src/routes/companies/[companySlug]/products.tsx?pick=default&pick=$css", "build": () => import(
  /* @vite-ignore */
  '../_/products-B1fupipg.mjs'
), "import": () => import(
  /* @vite-ignore */
  '../_/products-B1fupipg.mjs'
) }, "path": "/companies/:companySlug/products" }, { "page": true, "$component": { "src": "src/routes/companies/[companySlug]/products/[productSlug].tsx?pick=default&pick=$css", "build": () => import(
  /* @vite-ignore */
  '../_/_productSlug_-86A3ofmY.mjs'
), "import": () => import(
  /* @vite-ignore */
  '../_/_productSlug_-86A3ofmY.mjs'
...
const siteConfig = {
  name: "Free The World",
  description: "A registry of companies whose moats look much less permanent once AI, open source, Bitcoin, and distributed manufacturing finish making overpriced software and services look faintly ridiculous.",
  basePath: "/",
  publicationUrl,
...
var _tmpl$$4 = ["<section", ">", "</section>"], _tmpl$2$3 = ["<span", ">", "</span>"], _tmpl$3 = ["<div", '><table class="min-w-full border-collapse text-left text-sm">', "</table></div>"], _tmpl$4 = ["<div", "><!--$-->", '<!--/--><div class="space-y-2"><h2 class="text-2xl font-semibold tracking-tight text-[var(--color-foreground)] sm:text-3xl">', "</h2><!--$-->", "<!--/--></div></div>"], _tmpl$5 = ["<p", ' class="text-xs font-semibold uppercase tracking-[0.3em] text-[var(--color-accent)]">', "</p>"], _tmpl$6 = ["<p", ' class="max-w-3xl text-sm leading-7 text-[var(--color-muted-foreground)] sm:text-base">', "</p>"];
const buttonVariants = cva("inline-flex items-center justify-center rounded-xl border text-sm font-medium transition focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-accent)] disabled:pointer-events-none disabled:opacity-50", {
  variants: {
    variant: {
      primary: "border-[var(--color-accent)] bg-[var(--color-accent)] px-4 py-2 text-[var(--color-accent-foreground)] shadow-lg shadow-[var(--color-accent-shadow)] hover:brightness-110",
      secondary: "border-[var(--color-border)] bg-[var(--color-surface-elevated)] px-4 py-2 text-[var(--color-foreground)] hover:border-[var(--color-accent)] hover:text-[var(--color-accent)]",
...
function Button(props) {
  ...
  return createComponent(Dynamic, mergeProps$1({
    get component() {
      var _a;
      return (_a = local.as) != null ? _a : "button";
    },
    get ["class"]() {
...
function Card(props) {
  return ssr(_tmpl$$4, ssrHydrationKey() + ssrAttribute("class", escape(cn("rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)]/92 p-5 shadow-xl shadow-black/15 backdrop-blur", props.class), true), false), escape(props.children));
}
function Badge(props) {
  var _a;
  const toneClasses = {
    default: "border-[var(--color-border)] bg-white/5 text-[var(--color-foreground)]",
    accent: "border-[color-mix(in_oklab,var(--color-accent),black_25%)] bg-[var(--color-accent-soft)] text-[var(--color-foreground)]",
    muted: "border-[var(--color-border)] bg-[var(--color-surface-elevated)] text-[var(--color-muted-foreground)]"
  };
  return ssr(_tmpl$2$3, ssrHydrationKey() + ssrAttribute("class", escape(cn("inline-flex items-center rounded-full border px-3 py-1 text-xs font-medium uppercase tracking-[0.22em]", toneClasses[(_a = props.tone) != null ? _a : "default"], props.class), true), false), escape(props.children));
}
function Input(props) {
  return ssrElement("input", mergeProps$1(props, {
    get ["class"]() {
      return cn("h-11 w-full rounded-xl border border-[var(--color-border)] bg-[var(--color-surface-elevated)] px-4 text-sm text-[var(--color-foreground)] outline-none transition placeholder:text-[var(--color-muted-foreground)] focus:border-[var(--color-accent)]", props.class);
    }
  }), void 0, true);
}
function Select(props) {
  return ssrElement("select", mergeProps$1(props, {
    get ["class"]() {
      return cn("h-11 w-full rounded-xl border border-[var(--color-border)] bg-[var(--color-surface-elevated)] px-4 text-sm text-[var(--color-foreground)] outline-none transition focus:border-[var(--color-accent)]", props.class);
    }
  }), void 0, true);
}
const Table = (props) => ssr(_tmpl$3, ssrHydrationKey() + ssrAttribute("class", escape(cn("overflow-x-auto rounded-2xl border border-[var(--color-border)]", props.class), true), false), escape(props.children));
const SectionHeading = (props) => ssr(_tmpl$4, ssrHydrationKey() + ssrAttribute("class", escape(cn("space-y-3", props.class), true), false), props.eyebrow ? ssr(_tmpl$5, ssrHydrationKey(), escape(props.eyebrow)) : escape(null), escape(props.title), props.description ? ssr(_tmpl$6, ssrHydrationKey(), escape(props.description)) : escape(null));
var _tmpl$$3 = ["<span", ' class="text-lg font-semibold tracking-[0.18em] uppercase">', "</span>"], _tmpl$2$2 = ["<div", ' class="min-h-screen bg-[var(--color-background)] text-[var(--color-foreground)]"><div class="mx-auto flex min-h-screen w-full max-w-7xl flex-col px-4 pb-10 sm:px-6 lg:px-8"><header class="sticky top-0 z-20 mt-4 border border-[var(--color-border)] bg-[color-mix(in_oklab,var(--color-background),transparent_10%)]/90 px-4 py-4 backdrop-blur sm:px-6 rounded-2xl"><div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between"><div class="space-y-2"><!--$-->', '<!--/--><p class="max-w-xl text-sm text-[var(--color-muted-foreground)]">A running ledger of corporate moats, decentralizability, and the capital still trapped inside products that insist on charging rent for what should soon be free.</p></div><div class="flex flex-col gap-3 lg:items-end"><nav class="flex flex-wrap items-center gap-2">', "</nav><!--$-->", '<!--/--></div></div></header><main class="flex-1 py-10">', '</main><footer class="mt-8 rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] px-5 py-6"><div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between"><div class="space-y-2"><p class="text-sm font-medium">', '</p><p class="max-w-2xl text-sm text-[var(--color-muted-foreground)]">Built as a research surface for tracking how AI, open source, Bitcoin rails, and distributed manufacturing steadily make legacy pricing models look like an elaborate historical accident.</p></div><p class="text-xs uppercase tracking-[0.28em] text-[var(--color-muted-foreground)]">', "</p></div></footer></div></div>"];
const navigation = [{
  href: "/",
  label: "Home"
}, {
...
function NavLink(props) {
  const location = useLocation();
  const isActive = () => props.href === "/" ? location.pathname === props.href : location.pathname === props.href || location.pathname.startsWith(`${props.href}/`);
  return createComponent(A, {
    get href() {
      return props.href;
    },
    get ["class"]() {
      return cn("rounded-full px-4 py-2 text-sm transition", isActive() ? "bg-[var(--color-accent-soft)] text-[var(--color-foreground)]" : "text-[var(--color-muted-foreground)] hover:text-[var(--color-foreground)]");
    },
    get children() {
      return props.label;
    }
...
function SiteShell(props) {
  return ssr(_tmpl$2$2, ssrHydrationKey(), escape(createComponent(A, {
    href: "/",
    "class": "inline-flex items-center gap-3",
    get children() {
      return [createComponent(Badge, {
        tone: "accent",
        children: "Dark mode by default"
      }), ssr(_tmpl$$3, ssrHydrationKey(), escape(siteConfig.name))];
    }
  })), escape(navigation.map((item) => createComponent(NavLink, {
    get href() {
      return item.href;
    },
    get label() {
    ...
    as: "a",
    get href() {
      return siteConfig.publicationUrl;
    },
    target: "_blank",
    rel: "noreferrer",
    variant: "secondary",
    children: "Newsletter on Substack"
  })), escape(props.children), escape(siteConfig.name), escape(siteConfig.snapshotLabel));
}
function App$1() {
  return createComponent(MetaProvider, {
    get children() {
      return createComponent(Router, {
        ...
        root: (props) => createComponent(SiteShell, {
          get children() {
...
async function createPageEvent(ctx) {
  ...
  const assets = [
    ...
    ...await manifest2.getAssets("/workspace/src/app.tsx")
...
var _tmpl$ = ['<head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="theme-color" content="#4f46e5"><meta name="description"', ">", "</head>"], _tmpl$2 = ["<html", ' lang="en">', '<body><div id="app">', "</div><!--$-->", "<!--/--></body></html>"];
const entryServer = createHandler(() => createComponent(StartServer, {
  document: ({
    ...
    get children() {
      return ssr(_tmpl$, ssrAttribute("content", escape(siteConfig.description, true), false), escape(assets));
    }
...
export { A, Badge as B, Card as C, Input as I, SectionHeading as S, Title as T, Button as a, Select as b, Table as c, entry$1 as e, siteConfig as s, useParams as u };
