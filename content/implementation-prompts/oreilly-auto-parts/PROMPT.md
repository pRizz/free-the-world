...
- Product summary: O'Reilly Auto Parts is the consumer-facing retail and ecommerce channel for automotive replacement parts, tools, supplies, equipment, accessories, in-store pickup, ship-to-home orders, and store services.
- Why it matters: It is the main interface through which O'Reilly turns inventory scale and store density into repair uptime for vehicle owners.
...
- OpenBoxes (open-source): OpenBoxes is open-source inventory and supply-chain software for warehouses, multi-facility stock management, shipments, and audit trails.. Homepage: https://openboxes.com/. Repo: https://github.com/openboxes/openboxes.
- OpenStreetMap repair-shop directory (open-source): OpenStreetMap-backed applications can expose open data about repair shops, service locations, and local automotive infrastructure without a proprietary directory owner.. Homepage: https://osmapp.org/.
...
- O'Reilly Auto Parts Store Services (O'Reilly Auto Parts) - https://www.oreillyauto.com/store-services
  Why it matters: Documents store-level services such as brake rotor or drum resurfacing and paint mixing that anchor the physical retail proposition.
...
- OsmAPP (OsmAPP) - https://osmapp.org/
  Why it matters: OpenStreetMap-backed application demonstrating open geodata reuse for local discovery layers.
