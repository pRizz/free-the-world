...
- Product category: Molecular diagnostics system
- Product homepage: https://www.cepheid.com/us/cepheid-solutions/systems/genexpert-systems/genexpert-xvi
- Product summary: Cepheid GeneXpert is a family of automated molecular diagnostic systems for PCR-based testing near the point of need.
- Why it matters: GeneXpert represents a high-value incumbent pattern: a distributed testing instrument that can be deployed broadly, but whose assays, cartridges, validation, and support remain centrally controlled by the vendor ecosystem.
...
- Open qPCR (open-source): Open qPCR is an open-source real-time PCR machine implementation intended to make qPCR hardware more accessible for labs and biology communities.. Homepage: https://sphere.diybio.org/projects/openqpcr/.
- NinjaPCR (open-source): NinjaPCR is an open-source PCR hardware project that includes low-cost qPCR, qLAMP, and digital PCR workstreams.. Homepage: https://ninjapcr.hisa.dev/.
...
- GeneXpert Family of Systems (Cepheid) - https://www.cepheid.com/us/cepheid-solutions/systems/genexpert-systems/genexpert-xvi
  Why it matters: Primary product page for the GeneXpert molecular diagnostic system family and its positioning around PCR results near testing sites.
- NinjaPCR (NinjaPCR) - https://ninjapcr.hisa.dev/
  Why it matters: Open-source low-cost PCR hardware project covering qPCR, qLAMP, and digital PCR directions.
- Open qPCR (Sphere / DIYbio) - https://sphere.diybio.org/projects/openqpcr/
  Why it matters: Open-source real-time PCR machine project used as a plausible open hardware alternative for lower-risk molecular testing contexts.
