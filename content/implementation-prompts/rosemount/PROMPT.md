...
- Product homepage: https://www.emerson.com/en/automation/measurement-instrumentation/rosemount
- Product summary: Rosemount is Emerson's measurement instrumentation brand for industrial sensing, including pressure, temperature, level, flow, and analytical measurement products.
- Why it matters: Industrial instruments are the physical data layer of process automation. Their accuracy, certification, calibration, and integration determine whether control systems can safely act on plant conditions.
...
- OpenEnergyMonitor (open-source): OpenEnergyMonitor provides open-source hardware and software for energy monitoring, including sensor-node and data-logging designs.. Homepage: https://openenergymonitor.org/. Repo: https://github.com/openenergymonitor.
...
- An Open-Source Data Acquisition System for Laboratory and Industrial Scale Applications (arXiv) - https://arxiv.org/abs/2207.03251
  Why it matters: Evidence that open data-acquisition systems can support laboratory and industrial-scale measurement use cases.
...
- OpenEnergyMonitor Documentation (OpenEnergyMonitor) - https://openenergymonitor.org/docs/emonpi3/overview.html
  Why it matters: Technical documentation for open-source monitoring hardware relevant to open instrumentation concepts.
- OpenEnergyMonitor GitHub Organization (OpenEnergyMonitor) - https://github.com/openenergymonitor
  Why it matters: Repository organization for OpenEnergyMonitor open-source hardware and software.
- PowerSensor3: A Fast and Accurate Open Source Power Measurement Tool (arXiv) - https://arxiv.org/abs/2504.17883
  Why it matters: Open hardware, firmware, and software measurement toolkit used as an enabler for open instrumentation concepts.
