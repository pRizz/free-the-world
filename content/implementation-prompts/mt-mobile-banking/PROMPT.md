...
- Mifos X (open-source): Mifos X and related Mifos digital public goods provide open-source core banking, account management, payment orchestration, and mobile banking building blocks for financial-service providers.. Homepage: https://mifos.org/.
