...
- Product category: nuclear-powered attack submarines
- Product homepage: https://gdmissionsystems.com/submarine-systems/virginia-class
- Product summary: Virginia-class submarines are U.S. Navy nuclear-powered attack submarines for which General Dynamics Electric Boat is a prime contractor and General Dynamics Mission Systems supplies key sonar and mission-system capabilities.
- Why it matters: The program illustrates General Dynamics' deepest defense moat: nuclear shipbuilding capacity, classified systems integration, long-cycle Navy procurement, and an industrial base that cannot be quickly replicated.
...
- ArduSub (open-source): ArduSub is an open-source ArduPilot-based control stack for remotely operated and autonomous underwater vehicles.. Homepage: https://www.ardusub.com/. Repo: https://github.com/ArduPilot/ardupilot.
...
- ArduSub Overview (ArduSub) - https://www.ardusub.com/
  Why it matters: Documentation for the open-source underwater ROV and AUV control stack.
- Blue Robotics Open Source (Blue Robotics) - https://bluerobotics.com/open-source/
  Why it matters: Reference for open-source underwater robotics software, hardware, and protocols in the Blue Robotics ecosystem.
...
- General Dynamics Electric Boat Awarded Contract Modification for Virginia-Class Submarines (General Dynamics) - https://www.gd.com/Articles/2025/03/25/electric-boat-awarded-contract-modification-for-virginia-class-submarines-long-lead-time-material
  Why it matters: Company release illustrating continuing Virginia-class submarine demand and industrial-base investment needs.
...
- Virginia-Class Fast Attack Submarines (General Dynamics Mission Systems) - https://gdmissionsystems.com/submarine-systems/virginia-class
  Why it matters: Official General Dynamics page describing Virginia-class submarine mission-system support and Electric Boat prime-contractor role.
