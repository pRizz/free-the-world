...
- Product category: Transcatheter structural-heart devices
...
- Product summary: Edwards' SAPIEN 3, SAPIEN 3 Ultra, and SAPIEN 3 Ultra RESILIA systems are transcatheter heart-valve platforms used for selected aortic stenosis and failed-bioprosthetic valve indications.
- Why it matters: SAPIEN is central to Edwards' TAVR franchise and illustrates a high-stakes medical-device moat built around clinical evidence, regulatory approvals, specialized delivery systems, tissue technology, and physician workflow lock-in.
...
- FEBio FINESSE valve modeling workflow (open-source): An open-source finite-element approach for estimating in vivo heart-valve strains using image-derived geometry and FEBio-based biomechanics tooling.. Homepage: https://arxiv.org/abs/2407.09629. Repo: https://github.com/febiosoftware/FEBio.
...
- 3D Printing of Heart Valves (Trends in Biotechnology) - https://www.sciencedirect.com/science/article/abs/pii/S0167779923003232
  Why it matters: Research review used to bound the promise and current limitations of 3D-printed heart valves for decentralized-manufacturing concepts.
...
- FEBio FINESSE: An Open-Source Finite Element Simulation Approach to Estimate In Vivo Heart Valve Strains Using Shape Enforcement (arXiv) - https://arxiv.org/abs/2407.09629
  Why it matters: Enabler source for open-source heart-valve biomechanics simulation and design-evaluation concepts.
