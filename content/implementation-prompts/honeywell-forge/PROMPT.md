...
- Product category: Industrial IoT and operations software
- Product homepage: https://www.honeywell.com/us/en/solutions/honeywell-forge
- Product summary: Honeywell Forge is an AI-enabled industrial IoT platform for operations across industrial, building, and aerospace environments.
- Why it matters: Forge is Honeywell's software control plane for turning equipment telemetry, operational data, and domain-specific analytics into recurring digital services.
...
- Eclipse Ditto (open-source): Eclipse Ditto is an open-source framework for building digital twins of IoT-connected devices using standard web APIs.. Homepage: https://eclipse.dev/ditto/. Repo: https://github.com/eclipse-ditto/ditto.
- ThingsBoard (open-source): ThingsBoard is an open-source IoT platform for device connectivity, data collection, processing, visualization, and device management.. Homepage: https://thingsboard.io/. Repo: https://github.com/thingsboard/thingsboard.
...
- Eclipse Ditto (Eclipse Foundation) - https://eclipse.dev/ditto/
  Why it matters: Open-source digital-twin framework used as a plausible replacement component for proprietary industrial IoT platforms.
- FIWARE Open Source Platform (FIWARE Foundation) - https://www.fiware.org/
  Why it matters: Open-source smart-solution, digital-twin, and data-space platform used as an enabler for federated industrial data systems.
...
- Honeywell Forge (Honeywell) - https://www.honeywell.com/us/en/solutions/honeywell-forge
  Why it matters: Product source describing Forge as an AI-enabled IoT platform for industrial, building, and aerospace operations.
...
- ThingsBoard Open-source IoT Platform (ThingsBoard) - https://thingsboard.io/
  Why it matters: Open-source IoT platform source for device connectivity, processing, visualization, SCADA, and self-hostable industrial monitoring.
